...
# Extensiones que aceptamos para el compilador de PostgreSQL
EXTENSIONES_VALIDAS = (".sql", ".txt")
...
class Archivo:
    ...
    # Metodo para validar si el archivo es .sql o .txt
    def es_valido(self):

        # Retornamos True si la extension esta permitida
        return self.obtener_extension() in EXTENSIONES_VALIDAS
